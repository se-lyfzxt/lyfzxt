...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { attracname: @attraction.attracname, city_id: @attraction.city_id, image: @attraction.image }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { attracname: @attraction.attracname, city_id: @attraction.city_id, image: @attraction.image }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
